...
class _$SigninModelImpl implements _SigninModel {
  const _$SigninModelImpl({this.password, this.email});
  ...
  @override
  String toString() {
    return 'SigninModel(password: $password, email: $email)';
  }
...
abstract class _SigninModel implements SigninModel {
  const factory _SigninModel({final String? password, final String? email}) =
      _$SigninModelImpl;
